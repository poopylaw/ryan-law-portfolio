        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            ...
            <p className="mb-4 text-zinc-400">
              ...
              3D-printed components, and an ESP32-based control system. Applied
              Reynolds number, pressure drag, and boundary-layer analysis to
              refine body geometry, incorporating an F-duct-inspired internal
              airflow channel to reduce drag.
            </p>
          ...
          >
            ...
            <p className="mb-4 text-zinc-400">
              Designed and fabricated a folding knife using Magnacut steel and
              a back lock mechanism. Evaluated material behavior, load paths,
              and component tolerances through prototyping and mechanical design
              analysis to ensure strength and reliability.
            </p>
            <p className="text-sm text-zinc-500">
          ...
          >
            ...
            <p className="mb-4 text-zinc-400">
              ...
              3D-printed enclosure under a 48-hour hackathon timeline.
            </p>
            <p className="text-sm text-zinc-500">
          ...
          >
            ...
            <p className="mb-4 text-zinc-400">
              ...
              using joystick and accelerometer inputs; integrated sensor
              processing, conditional logic, and display control in an embedded
              mechatronic system.
            </p>
            <p className="text-sm text-zinc-500">
