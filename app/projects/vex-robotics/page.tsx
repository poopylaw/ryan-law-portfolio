    ...
    <PageBackground>
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <p className="mb-10 text-lg leading-8 text-zinc-300">
          I served as Design Lead for a collegiate VEX Robotics team, leading
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-sky-400/10 bg-zinc-950/70 p-6 shadow-2xl shadow-sky-950/20 backdrop-blur">
            ...
            <p className="text-zinc-400">
              Design Lead responsible for mechanical design direction, subteam
        ...
        <section className="mt-12">
          ...
          <p className="leading-8 text-zinc-300">
            As Design Lead, I managed subteam workflow, task allocation, and
